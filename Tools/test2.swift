...
struct test2: View {
    ...
    func total_fuel_uplift() -> Int {
        return left_Sum - left_Before + center_Sum - center_Before + right_Sum - right_Before  + act_Sum - act_Sum
    }
            ...
            ZStack{
                ...
                VStack {
                    ...
                    HStack(spacing: 20){
                        Text("ACT")
                            .frame(width: 35)
                        TextField("A", value: $act_Before,formatter: NumberFormatter())
                            .keyboardType(.decimalPad)
                            .textFieldStyle(RoundedBorderTextFieldStyle())
                            .padding(.leading, 10)
                            .frame(width: 100)
                        ...
                        TextField("A", value: $act_Sum,formatter: NumberFormatter())
                            .keyboardType(.decimalPad)
                            .textFieldStyle(RoundedBorderTextFieldStyle())
                            .padding(.trailing, 10)
                            .frame(width: 100)
                    ...
                    HStack(spacing:20){
                        ...
                        Text("\(left_Sum - left_Before + center_Sum - center_Before + right_Sum - right_Before  + act_Sum - act_Sum)")
                            .textFieldStyle(RoundedBorderTextFieldStyle())
                            .frame(width: 80)
                            .padding(6.5)
                            .border(Color(red: 0.867, green: 0.867, blue: 0.867))
                    ...
                    VStack{
                        HStack(spacing: 50){
                            ...
                            VStack{
                                Text("Density")
                                TextField(" 0 " , value: $density, formatter: numberFormatter)
                                    .keyboardType(.decimalPad)
                                    .textFieldStyle(RoundedBorderTextFieldStyle())
                                    .frame(width: 90)
                                    .onAppear {
                        ...
                        HStack{
                            ...
                            VStack{
                                Text("Galon")
                                TextField(" 0 ", value: $volume_Galon, formatter: NumberFormatter())
                            ...
                            VStack{
                                Text("Liter")
                                TextField(" 0 ", value: $volume_Liter, formatter: NumberFormatter())
                            ...
                            VStack{
                                Text("Kg")
                                TextField(" 0 ", value: $volume_Kg, formatter: NumberFormatter())
